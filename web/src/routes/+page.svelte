...
<form on:submit|preventDefault={onCreateChat} id="form-create-chat" class="p-5" aria-label="Model Settings">
  ...
  <div class="grid grid-cols-3 gap-4 p-3 bg-base-200" id="model_settings" name="model_settings" aria>
    ...
    <div class="flex flex-col">
      ...
      <select name="model" id="models" class="select-bordered select w-full" aria-haspopup="menu">
