...
<div
  class="mx-auto h-full max-h-screen relative"
  on:keydown={handleKeyDown}
>
<div class="px-16 flex justify-between items-center">
  <a href="https://github.com/nsarrazin/serge" target="_blank" rel="noopener noreferrer">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="24" height="24">
      <path class="fill-neutral-content" d="M8 0c4.42 0 8 3.58 8 8a8.013 8.013 0 0 1-5.45 7.59c-.4.08-.55-.17-.55-.38 0-.27.01-1.13.01-2.2 0-.75-.25-1.23-.54-1.48 1.78-.2 3.65-.88 3.65-3.95 0-.88-.31-1.59-.82-2.15.08-.2.36-1.02-.08-2.12 0 0-.67-.22-2.2.82-.64-.18-1.32-.27-2-.27-.68 0-1.36.09-2 .27-1.53-1.03-2.2-.82-2.2-.82-.44 1.1-.16 1.92-.08 2.12-.51.56-.82 1.28-.82 2.15 0 3.06 1.86 3.75 3.64 3.95-.23.2-.44.55-.51 1.07-.46.21-1.61.55-2.33-.66-.15-.24-.6-.83-1.23-.82-.67.01-.27.38.01.53.34.19.73.9.82 1.13.16.45.68 1.31 2.69.94 0 .67.01 1.3.01 1.49 0 .21-.15.45-.55.38A7.995 7.995 0 0 1 0 8c0-4.42 3.58-8 8-8Z"></path>
    </svg>
  </a>
  <div>
...
<h4 class="text-xl font-semibold mb-5">
  ...
  >
  <div class="flex flex-row justify-between items-center w-full max-w-3xl bg-base-200 rounded-lg border border-[#2d333e] drop-shadow-md">
    <textarea
      autofocus
      name="question"
    ...
    <button on:mouseenter={onMouseEnter} on:mouseleave={onMouseLeave}
      type="submit"
      disabled={isLoading}
      class="btn btn-[transparent] bg-[transparent] border-0 h-10 w-14 text-lg hover:bg-gradient-to-t hover:from-primary hover:to-purple-400"
      class:loading={isLoading}
      on:click|preventDefault={askQuestion}
    >
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
        <path class="{sendBottomHovered ? 'fill-white' : 'fill-neutral-content'}" d="M.989 8 .064 2.68a1.342 1.342 0 0 1 1.85-1.462l13.402 5.744a1.13 1.13 0 0 1 0 2.076L1.913 14.782a1.343 1.343 0 0 1-1.85-1.463L.99 8Zm.603-5.288L2.38 7.25h4.87a.75.75 0 0 1 0 1.5H2.38l-.788 4.538L13.929 8Z"></path>
      </svg>       
    </button>
  </div>
  </div>
