    ...
    <div class="h-max pb-32">
      {#each history as question}
        {#if question.type === "human"}
          <div class="chat chat-start px-10 md:px-16 py-4 bg-base-200 border-t border-[#373d49]">
        ...
        {:else if question.type === "ai"}
          <div class="chat chat-start px-10 md:px-16 py-4 bg-base-100 border-t border-[#373d49]">
            <div class="chat-image self-start avatar pl-1 pt-1">
